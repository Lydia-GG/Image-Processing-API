...
describe('test image resizing', function () {
    it('resize the image', function () { return __awaiter(void 0, void 0, void 0, function () {
        var imagePath, originalImage, resizedImage, outputImage;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    imagePath = '../../images?filename=santamonica&width=100&height=100';
                    if (fs_1.default.existsSync(imagePath)) {
                        fs_1.default.unlinkSync(imagePath);
                        console.log('image exist');
                    }
                    originalImage = "../../images/full/santamonica.jpg";
                    resizedImage = "images/full/santamonica-100-100.jpg";
